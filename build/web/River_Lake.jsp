...
<body
    background = "Images/river.jpg" claas = "img-responsive">
    <div class="container">
      <div class = "row">
        <h1>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
    ...
    <h1>Rivers and Lakes of Bangladesh!</h1>
        <div style="margin-top:5px; margin-bottom: 5px;">
            <form action="./River_LakeServlet" method="POST">
            <input type="submit" name="action" id="btnRiver" value="See the Rivers and Lakes"/>
            </form>
            <div id="River_Lake" style="margin-top: 5px;">
                <fieldset>
                    <legend>Rivers and Lakes</legend>
                    <table id="River_Lake" style="width:100%;">
                        <thead>
                            <tr style="background-color: #cccccc;">
                                <th>River and Lakes</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="data">
                                ...
                                <tr>
                                    <td> <form action="./River_LakeServlet" method="POST">
                                        <input type="submit" name="action" id="btnRiver" value="${model.getPlaceName()}" /> 
                                        </form>
                                    </td>  
                                </tr>            
                                </c:forEach>
