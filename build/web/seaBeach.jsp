...
<body
    background = "Images/seaSide.jpg" claas = "img-responsive">
    <div class="container">
      <div class = "row">
        <h1>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
    ...
    <h1>Sea Beaches of Bangladesh!</h1>
        <div style="margin-top:5px; margin-bottom: 5px;">
            <form action="./SeaBeachServlet" method="POST">
            <input type="submit" name="action" id="btnBeach" value="See the Sea Beaches"/>
            </form>
            <div id="SeaBeach" style="margin-top: 5px;">
                <fieldset>
                    <legend>Sea Beach</legend>
                    <table id="SeaBeach" style="width:100%;">
                        <thead>
                        ...
                        <tbody>
                            <tr class="data">
                                ...
                                <tr>
                                    <td> <form action="./SeaBeachServlet" method="POST">
                                        <input type="submit" name="action" id="btnBeach" value="${model.getPlaceName()}" /> 
                                        </form>
                                    </td>  
                                </tr>            
                                </c:forEach>
