...
<body
    background = "Images/wf.jpg" claas = "img-responsive">
    <div class="container">
      <div class = "row">
        <h1>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
    ...
    <h1>Water Falls of Bangladesh!</h1>
        <div style="margin-top:5px; margin-bottom: 5px;">
            <form action="./WaterFallServlet" method="POST">
            <input type="submit" name="action" id="btnWaterFall" value="See the Water Falls"/>
            </form>
            <div id="WaterFall" style="margin-top: 5px;">
                <fieldset>
                    <legend>Water Fall</legend>
                    <table id="WaterFall" style="width:100%;">
                        <thead>
                        ...
                        <tbody>
                            <tr class="data">
                                ...
                                <tr>
                                    <td> <form action="./WaterFallServlet" method="POST">
                                        <input type="submit" name="action" id="btnWaterFall" value="${model.getPlaceName()}" /> 
                                        </form>
                                    </td>  
                                </tr>            
                                </c:forEach>
