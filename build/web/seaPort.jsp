...
<body
    background = "Images/port.jpg" claas = "img-responsive">
    <div class="container">
      <div class = "row">
        <h1>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
    ...
    <h1>Sea Ports of Bangladesh!</h1>
        <div style="margin-top:5px; margin-bottom: 5px;">
            <form action="./SeaPortServlet" method="POST">
            <input type="submit" name="action" id="btnport" value="See the Sea Ports"/>
            </form>
            <div id="SeaPort" style="margin-top: 5px;">
                <fieldset>
                    <legend>Sea Port</legend>
                    <table id="SeaPort" style="width:100%;">
                        <thead>
                        ...
                        <tbody>
                            <tr class="data">
                                ...
                                <tr>
                                    <td> <form action="./SeaPortServlet" method="POST">
                                        <input type="submit" name="action" id="btnport" value="${model.getPlaceName()}" /> 
                                        </form>
                                    </td>  
                                </tr>            
                                </c:forEach>
