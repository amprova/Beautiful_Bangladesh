...
<body
    background = "Images/archaeo.jpg" claas = "img-responsive">
    <div class="container">
      <div class = "row">
        <h1>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
    ...
    <h1>Archaeological Sides of Bangladesh!</h1>
        <div style="margin-top:5px; margin-bottom: 5px;">
            <form action="./ArchaeologicalServlet" method="POST">
            <input type="submit" name="action" id="btnArchaeological" value="See the Archaeological Sides"/>
            </form>
            <div id="Architectural" style="margin-top: 5px;">
                <fieldset>
                    <legend>Archaeological</legend>
                    <table id="Architectural" style="width:100%;">
                        <thead>
                            <tr style="background-color: #cccccc;">
                                <th>Archaeological Sides</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="data">
                                ...
                                <tr>
                                    <td> <form action="./ArchaeologicalServlet" method="POST">
