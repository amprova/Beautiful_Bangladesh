<%-- 
    Document   : Hotel.jsp
    Created on : May 30, 2015, 6:39:58 PM
    Author     : USER
--%>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
      <ul>
        ...
        <h1> Hotels </h1>
<img src = Images/hotel.jpg > <br> <br>
There are different hotels in Bangladesh. They are categorized as 5 star, 3 star etc. List hotels in different places can be found in the place description.
