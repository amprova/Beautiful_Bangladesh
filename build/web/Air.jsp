<%-- 
    Document   : Air
    Created on : May 30, 2015, 6:43:11 PM
    Author     : USER
--%>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
      <ul>
        ...
        <h1> By Air </h1>
<img src = Images/air.jpg > <br> <br>
One can go to some specific places by air. There are some private airlines companies in Bangladesh. Biman Bangladesh provides air routes to these places too.
