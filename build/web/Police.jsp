<%-- 
    Document   : Police
    Created on : May 30, 2015, 6:41:40 PM
    Author     : USER
--%>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
      <ul>
        ...
        <h1>Police Contacts </h1>
<img src = Images/police.png > <br> <br>
<img src = Images/police2.png > <br> <br>
The Bangladesh Police is the main law enforcement agency of Bangladesh.
It is administered under the Ministry of Home Affairs of the Government of Bangladesh.
It plays a crucial role in maintaining peace, and enforcement of law and order within Bangladesh.
Though the police are primarily concerned with the maintenance of law and order and security of persons and property of individuals,
they also play a big role in the criminal justice system.
Contacts of different police stations are provided in different places information.
    </body>
</html>
