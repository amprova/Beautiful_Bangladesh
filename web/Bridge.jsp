...
<body
    background = "Images/bridge.jpg" claas = "img-responsive">
    <div class="container">
      <div class = "row">
        <h1>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
    ...
    <h1>Bridges of Bangladesh!</h1>
        <div style="margin-top:5px; margin-bottom: 5px;">
            <form action="./BridgeServlet" method="POST">
            <input type="submit" name="action" id="btnBridge" value="See the Bridges"/>
            </form>
            <div id="Bridge" style="margin-top: 5px;">
                <fieldset>
                    <legend>Bridges</legend>
                    <table id="Bridge" style="width:100%;">
                        <thead>
                        ...
                        <tbody>
                            <tr class="data">
                                ...
                                <tr>
                                    <td> <form action="./BridgeServlet" method="POST">
                                        <input type="submit" name="action" id="btnBridge" value="${model.getPlaceName()}" /> 
                                        </form>
                                    </td>  
                                </tr>            
                                </c:forEach>
