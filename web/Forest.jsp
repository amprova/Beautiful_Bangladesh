...
<body
    background = "Images/jung.jpg" claas = "img-responsive">
    <div class="container">
      <div class = "row">
        <h1>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
    ...
    <h1>Forests of Bangladesh!</h1>
        <div style="margin-top:5px; margin-bottom: 5px;">
            <form action="./ForestServlet" method="POST">
            <input type="submit" name="action" id="btnForest" value="See the Forests"/>
            </form>
            <div id="Bridge" style="margin-top: 5px;">
                <fieldset>
                    <legend>Forests</legend>
                    <table id="Forest" style="width:100%;">
                        <thead>
                        ...
                        <tbody>
                            <tr class="data">
                                ...
                                <tr>
                                    <td> <form action="./ForestServlet" method="POST">
                                        <input type="submit" name="action" id="btnForest" value="${model.getPlaceName()}" /> 
                                        </form>
                                    </td>  
                                </tr>            
                                </c:forEach>
