<%-- 
    ...
    Created on : May 23, 2015, 1:33:00 PM
    Author     : USER
--%>
...
<body
    background = "Images/architect.jpg" claas = "img-responsive">
    <div class="container">
      <div class = "row">
        <h1>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
    ...
    <h1>Architectural Sides of Bangladesh!</h1>
        <div style="margin-top:5px; margin-bottom: 5px;">
            <form action="./ArchitecturalServlet" method="POST">
            <input type="submit" name="action" id="btnArchaeological" value="See the Architectural Beauties"/>
            </form>
            <div id="Architectural" style="margin-top: 5px;">
                <fieldset>
                    <legend>Architectural</legend>
                    <table id="Architectural" style="width:100%;">
                        <thead>
                            <tr style="background-color: #cccccc;">
                                <th>Architectural Beauties</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="data">
                                ...
                                <tr>
                                    <td> <form action="./ArchitecturalServlet" method="POST">
                                        <input type="submit" name="action" id="btnSeaArea" value="${model.getPlaceName()}" /> 
                                        </form>
                                    </td>  
                                </tr>            
                                </c:forEach>
