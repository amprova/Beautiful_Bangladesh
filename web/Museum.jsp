...
<body
    background = "Images/museum.jpg" claas = "img-responsive">
    <div class="container">
      <div class = "row">
        <h1>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
    ...
    <h1>Museums of Bangladesh!</h1>
        <div style="margin-top:5px; margin-bottom: 5px;">
            ...
            <input type="submit" name="action" id="btnMuseum" value="See the Museums"/>
            </form>
            <div id="Museum" style="margin-top: 5px;">
                <fieldset>
                    <legend>Museum</legend>
                    <table id="Museum" style="width:100%;">
                        <thead>
                        ...
                        <tbody>
                            <tr class="data">
                                ...
                                <tr>
                                    <td> <form action="./MuseumServlet" method="POST">
                                        <input type="submit" name="action" id="btnMuseum" value="${model.getPlaceName()}" /> 
                                        </form>
                                    </td>  
                                </tr>            
                                </c:forEach>
