...
<body
    background = "Images/island.jpg" claas = "img-responsive">
    <div class="container">
      <div class = "row">
        <h1>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
    ...
    <h1>Islands of Bangladesh!</h1>
        <div style="margin-top:5px; margin-bottom: 5px;">
            <form action="./IslandsServlet" method="POST">
            <input type="submit" name="action" id="btnisland" value="See the Islands"/>
            </form>
            <div id="Islands" style="margin-top: 5px;">
                <fieldset>
                    <legend>Islands</legend>
                    <table id="Islands" style="width:100%;">
                        <thead>
                        ...
                        <tbody>
                            <tr class="data">
                                ...
                                <tr>
                                    <td> <form action="./IslandsServlet" method="POST">
                                        <input type="submit" name="action" id="btnisland" value="${model.getPlaceName()}" /> 
                                        </form>
                                    </td>  
                                </tr>            
                                </c:forEach>
