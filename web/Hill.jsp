...
<body
    background = "Images/hill.jpg" claas = "img-responsive">
    <div class="container">
      <div class = "row">
        <h1>
...
<ul>
   ...
   <li class='#'><a href='#'><span>Gallery</span></a>
    ...
    <h1>Hills of Bangladesh!</h1>
        <div style="margin-top:5px; margin-bottom: 5px;">
            <form action="./HillsServlet" method="POST">
            <input type="submit" name="action" id="btnHills" value="See the Hills"/>
            </form>
            <div id="Hills" style="margin-top: 5px;">
                <fieldset>
                    <legend>Hills</legend>
                    <table id="Hills" style="width:100%;">
                        <thead>
                        ...
                        <tbody>
                            <tr class="data">
                                ...
                                <tr>
                                    <td> <form action="./HillsServlet" method="POST">
                                        <input type="submit" name="action" id="btnHills" value="${model.getPlaceName()}" /> 
                                        </form>
                                    </td>  
                                </tr>            
                                </c:forEach>
